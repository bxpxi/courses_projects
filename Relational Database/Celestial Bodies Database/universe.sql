...
CREATE TABLE public.blackhole (
    ...
    name character varying(255) DEFAULT 'blackhole'::character varying,
    blackhole_name_code character varying(255)
);
...
CREATE TABLE public.galaxy (
    ...
    galaxy_name_code character varying(255)
);
...
CREATE TABLE public.planet (
    ...
    planet_name_code character varying(255)
);
...
CREATE TABLE public.star (
    ...
    name character varying(255) NOT NULL,
    galaxy_id integer,
    columnstar_name_code character varying(255)
);
...
INSERT INTO public.blackhole VALUES (1, 100, 1, true, 'blackhole1', NULL);
INSERT INTO public.blackhole VALUES (2, 100, 1, true, 'blackhole3', NULL);
INSERT INTO public.blackhole VALUES (3, 100, 1, true, 'blackhole3', NULL);
...
INSERT INTO public.galaxy VALUES (2, NULL, NULL, 'galaxy2', 10000, NULL);
...
INSERT INTO public.planet VALUES (11, 'jalaala', NULL, false, 2, NULL);
INSERT INTO public.planet VALUES (12, 'malaala', NULL, false, 2, NULL);
...
INSERT INTO public.star VALUES (5, 123461234, 'orange', 'small orange', 1, NULL);
INSERT INTO public.star VALUES (6, 123461234, 'orange', 'star in galaxy 2', 2, NULL);
...
--
-- Name: blackhole blackhole_blackhole_name_code_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.blackhole
    ADD CONSTRAINT blackhole_blackhole_name_code_key UNIQUE (blackhole_name_code);
...
--
-- Name: star star_columnstar_name_code_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.star
    ADD CONSTRAINT star_columnstar_name_code_key UNIQUE (columnstar_name_code);
